...
public class ConfigUtilsTest {
  ...
  public void testValidateOptionOrEnv(String propValue, String envPropValue, boolean expectSuccess) {
  ...
  public void testGetEffectivePropertyWithParser(String envProperty, Integer property, Integer expected) {
